...
public class StudentReaderTest {
	...
	public void testReadFile() {
		...
		Student s1 = contents[0];
		assertTrue("Amber".equals(s1.getFirst()));
		assertEquals("Michael", s1.getLast());
		assertEquals("michaea", s1.getUnityID());
		assertEquals(1, s1.getId());
		assertEquals(10 , s1.getCreditHours());
