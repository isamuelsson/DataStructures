...
public class SelectionSorterTest {
	...
	/**
	 * Tests the SelectionSorter sort method on Integer objects.
	 */
	@Test
	...
	/**
	 * Tests the SelectionSorter sort method on Student objects.
	 */
	@Test
	public void testSortStudent() {
		
		selectionSorter.sort(dataRandom2);		
		...
		selectionSorter.sort(dataDescending2);		
		...
		selectionSorter.sort(dataAscending2);		
